...
// نسخه نهایی: پرینت کامل با ستون خرید دستی
        ...
        stats.shortages.forEach((item, index) => {
            ...
            htmlContent += `
                <tr>
                    ...
                    <td>${item.qty}</td>
                    <td>${item.min}</td>
                    <td class="empty-col"></td> <!-- ستون خالی برای نوشتن -->
                </tr>
            `;
        });
