...
// نسخه بهینه‌سازی شده با مدیریت پیشرفته خطا و رندرینگ سریع
...
// ----------------------------------------------------------------------------------------------------
=======
// تولید کد اختصاصی قطعه برای نمایش در لاگ‌ها
>>>>>>> 6082b098671e7ba81b4cc0aab3cbbb088c775c13
...
=======
/**
 * مودال ویرایش لاگ (اصلاح تراکنش‌های اشتباه)
 */
>>>>>>> 6082b098671e7ba81b4cc0aab3cbbb088c775c13
const EditLogModal = ({ isOpen, onClose, onSave, log }) => {
    const [qty, setQty] = useState(0);
    const [reason, setReason] = useState("");
    const [editReason, setEditReason] = useState(""); // استیت جدید

    useEffect(() => {
        if (log && isOpen) {
            setQty(log.quantity_added);
            setReason(log.reason || "");
            setEditReason(log.edit_reason || ""); // خواندن مقدار قبلی
        }
    }, [log, isOpen]);

    if (!isOpen || !log) return null;

    // ارسال کل داده‌ها به عنوان یک آبجکت
    const handleConfirm = () => {
        onSave({
            log_id: log.log_id,
            quantity_added: qty,
...
=======
/**
 * کامپوننت انتخاب تاریخ شمسی اختصاصی
 */
>>>>>>> 6082b098671e7ba81b4cc0aab3cbbb088c775c13
...
=======
/**
 * صفحه مدیریت تامین‌کنندگان (Contacts)
 */
>>>>>>> 6082b098671e7ba81b4cc0aab3cbbb088c775c13
...
=======
    ...
    // فیلتر کردن هوشمند مخاطبین براساس جستجو
>>>>>>> 6082b098671e7ba81b4cc0aab3cbbb088c775c13
...
=======
    // کپی کردن متن در کلیپ‌بورد با فیدبک بصری
>>>>>>> 6082b098671e7ba81b4cc0aab3cbbb088c775c13
...
=======
    // بارگذاری لاگ‌ها و تنظیمات سیستمی
>>>>>>> 6082b098671e7ba81b4cc0aab3cbbb088c775c13
...
<<<<<<< HEAD
    ...
    // ------------------------------------------------------------------------------------------------
=======
    // حذف یک تراکنش و بازگردانی خودکار موجودی انبار
>>>>>>> 6082b098671e7ba81b4cc0aab3cbbb088c775c13
...
=======
    // بروزرسانی یک تراکنش و اعمال تفاضل در انبار
...
>>>>>>> 6082b098671e7ba81b4cc0aab3cbbb088c775c13
        try {
            ...
            if (result.ok) {
                ...
                // نمایش دقیق خطا اگر سرور قبول نکرد (مثلا اگر ستون دیتابیس نبود)
...
<<<<<<< HEAD
    ...
    // ------------------------------------------------------------------------------------------------
=======
    // فیلتر کردن لاگ‌ها براساس معیارهای مختلف
>>>>>>> 6082b098671e7ba81b4cc0aab3cbbb088c775c13
...
<<<<<<< HEAD
                            ...
                            if (isDelete) {
                                // [اصلاح شده] استایل قرمز مخصوص حذف
                                colorClass = 'text-red-700';
                                bgClass = 'bg-red-950/60'; // پس‌زمینه قرمز کمرنگ
                                borderColor = 'border-red-900'; // کادر قرمز
                                iconName = 'trash-2';
                                titleText = 'حذف قطعه';
                            } 
                            else if (isEdit) {
...
>>>>>>> 6082b098671e7ba81b4cc0aab3cbbb088c775c13
                            ...
                            return (
                                <div key={l.log_id} className="flex gap-4 group animate-in slide-in-from-right-2 duration-300">
                                    {/* آیکون عملیات با استایل داینامیک */}
...
>>>>>>> 6082b098671e7ba81b4cc0aab3cbbb088c775c13
                                            ...
                                            {/* نمایش لیست تغییرات (edit_reason) */}
