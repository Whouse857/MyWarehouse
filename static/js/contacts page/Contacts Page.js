                ...
                <div className="xl:col-span-4 h-full overflow-y-auto custom-scroll">
                    <div className="glass-panel border border-white/10 rounded-2xl p-5 shadow-2xl relative bg-gradient-to-b from-white/5 to-[#020617] animate-fade-in">
                        ...
                        <div className="space-y-4">
                            <NexusInput dir="rtl" label="نام شرکت / شخص *" value={newContact.name} onChange={e => handleChange('name', e.target.value)} disabled={!serverStatus} error={errors.name} placeholder="فروشگاه قطعات..." />
                            ...
                            <NexusInput dir="rtl" label="آدرس دقیق *" value={newContact.address} onChange={e => handleChange('address', e.target.value)} disabled={!serverStatus} error={errors.address} placeholder="شهر، خیابان..." />
