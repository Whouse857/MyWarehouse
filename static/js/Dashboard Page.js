/**
 * نام فایل: Dashboard Page.js
 * نویسنده: سرگلی
 * نسخه: V0.20
 * * کلیات عملکرد و توابع:
 * این ماژول صفحه اصلی (داشبورد) نرم‌افزار را نمایش می‌دهد.
 * وظیفه اصلی آن نمایش کارت‌های دسترسی به ماژول‌های مختلف (مانند انبار، کاربران و...)
 * بر اساس سطح دسترسی کاربر (Permission) است.
 * * توابع و بخش‌های کلیدی:
 * 1. allItems: تعریف آرایه‌ای از تمام ماژول‌های موجود در سیستم و مشخصات آن‌ها (آیکون، رنگ، مجوز مورد نیاز).
 * 2. visibleItems: فیلتر کردن ماژول‌ها بر اساس تابع hasPerm (که از والد دریافت شده) برای نمایش فقط موارد مجاز.
 * 3. useEffect (Icon Refresh): بازخوانی آیکون‌های Lucide پس از تغییر لیست آیتم‌های قابل نمایش.
 */
...
const DashboardPage = ({ setView, user, hasPerm }) => {
    ...
    // =========================================================================
    /**
     * نام بخش: تعریف کارت‌های داشبورد (allItems)
     * کارایی: لیست تمام ماژول‌های سیستم به همراه آیکون، رنگ و مجوز مورد نیاز برای دسترسی
     */
    // =========================================================================
    const allItems = [
    ...
    // =========================================================================
    /**
     * نام بخش: فیلتر دسترسی (visibleItems)
     * کارایی: فیلتر کردن آیتم‌ها بر اساس تابع hasPerm که از والد آمده است.
     * نکته: این روش ایمن‌ترین راه است چون منطق دسترسی فقط در Main Application مدیریت می‌شود.
     */
    // =========================================================================
    ...
    // =========================================================================
    /**
     * نام هوک: useEffect (رفرش آیکون‌ها)
     * کارایی: اطمینان از رندر صحیح آیکون‌های Lucide پس از لود شدن لیست ماژول‌های مجاز
     */
    // =========================================================================
    React.useEffect(() => {
        setTimeout(() => {
