/**
 * نام فایل: admin_backup.js
 * نویسنده: سرگلی
 * نسخه: V0.20
 * * کلیات عملکرد و توابع:
 * این ماژول مسئولیت مدیریت عملیات پشتیبان‌گیری و بازیابی پایگاه‌داده را بر عهده دارد.
 * * توابع کلیدی:
 * 1. loadBackups: فراخوانی لیست تمامی بک‌آپ‌های موجود از سرور و به‌روزرسانی وضعیت (State).
 * 2. handleFileUpload: مدیریت آپلود دستی فایل دیتابیس توسط کاربر و ارسال به سرور جهت بازگردانی (Restore).
 * 3. handleCreateBackup: ارسال درخواست به API جهت ایجاد یک نسخه پشتیبان جدید روی سرور با نام کاربر فعلی.
 * 4. handleRestore: اجرای فرآیند بازگردانی اطلاعات از یک فایل مشخص موجود در لیست بک‌آپ‌ها.
 * 5. handleDelete: حذف فیزیکی یک فایل بک‌آپ از حافظه سرور پس از تایید کاربر.
 * 6. toShamsiWithSeconds: مبدل تاریخ میلادی به شمسی با فرمت دقیق (ساعت، دقیقه، ثانیه) برای نمایش در کارت‌های بک‌آپ.
 * 7. handleDownload: ایجاد لینک مستقیم جهت دریافت و ذخیره‌سازی فایل بک‌آپ روی سیستم شخصی کاربر.
 */
...
const BackupPage = () => {
    ...
    // =========================================================================
    /**
     * نام تابع: loadBackups
     * کارایی: دریافت لیست فایل‌های پشتیبان از سرور و ذخیره در state
     */
    // =========================================================================
    ...
    // =========================================================================
    /**
     * نام تابع: handleFileUpload
     * کارایی: پردازش فایل آپلود شده توسط کاربر برای بازگردانی دستی دیتابیس
     */
    // =========================================================================
    ...
    // =========================================================================
    /**
     * نام تابع: handleCreateBackup
     * کارایی: درخواست ساخت یک نسخه پشتیبان جدید در سرور
     */
    // =========================================================================
    ...
    // =========================================================================
    /**
     * نام تابع: handleRestore
     * کارایی: بازگردانی دیتابیس به نسخه انتخاب شده از لیست
     */
    // =========================================================================
     ...
     * کارایی: حذف دایمی فایل پشتیبان از سرور
     */
    // =========================================================================
    ...
    // =========================================================================
    /**
     * نام تابع: toShamsiWithSeconds
     * کارایی: تبدیل تاریخ میلادی به فرمت خوانای شمسی (همراه با ثانیه)
     */
    // =========================================================================
    ...
    // =========================================================================
    /**
     * نام تابع: handleDownload
     * کارایی: باز کردن لینک دانلود فایل پشتیبان در تب جدید
     */
    // =========================================================================
